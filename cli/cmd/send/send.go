...
func init() {
	...
	CmdSend.Flags().StringSliceVarP(&sendFlags.ProtoImport, "proto-import", "I", []string{}, "Proto Import Path")
	CmdSend.Flags().StringSliceVarP(&sendFlags.ProtoFile, "proto-file", "f", []string{}, "Proto File")
